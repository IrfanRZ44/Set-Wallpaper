...
.method constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ah;->a:Landroid/support/v4/f/a;

    new-instance v0, Landroid/support/v4/f/f;

    invoke-direct {v0}, Landroid/support/v4/f/f;-><init>()V

    iput-object v0, p0, Landroid/support/v7/widget/ah;->b:Landroid/support/v4/f/f;
...
.method private a(Landroid/support/v7/widget/RecyclerView$ViewHolder;I)Landroid/support/v7/widget/RecyclerView$ItemAnimator$ItemHolderInfo;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ah;->a:Landroid/support/v4/f/a;
    ...
    iget v3, v0, Landroid/support/v7/widget/ah$a;->a:I

    and-int/2addr v3, p2

    if-eqz v3, :cond_0

    iget v1, v0, Landroid/support/v7/widget/ah$a;->a:I

    xor-int/lit8 v3, p2, -0x1

    and-int/2addr v1, v3

    iput v1, v0, Landroid/support/v7/widget/ah$a;->a:I

    const/4 v1, 0x4

    if-ne p2, v1, :cond_2

    iget-object v1, v0, Landroid/support/v7/widget/ah$a;->b:Landroid/support/v7/widget/RecyclerView$ItemAnimator$ItemHolderInfo;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/ah;->a:Landroid/support/v4/f/a;

    invoke-virtual {v3, v2}, Landroid/support/v4/f/a;->d(I)Ljava/lang/Object;

    invoke-static {v0}, Landroid/support/v7/widget/ah$a;->a(Landroid/support/v7/widget/ah$a;)V
    ...
    iget-object v1, v0, Landroid/support/v7/widget/ah$a;->c:Landroid/support/v7/widget/RecyclerView$ItemAnimator$ItemHolderInfo;
...
.method a(J)Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ah;->b:Landroid/support/v4/f/f;
...
.method a(Landroid/support/v7/widget/RecyclerView$ViewHolder;Landroid/support/v7/widget/RecyclerView$ItemAnimator$ItemHolderInfo;)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ah;->a:Landroid/support/v4/f/a;
...
.method a(Landroid/support/v7/widget/ah$b;)V
    ...
    iget v3, v1, Landroid/support/v7/widget/ah$a;->a:I
    ...
    invoke-interface {p1, v0}, Landroid/support/v7/widget/ah$b;->a(Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
    ...
    iget-object v3, v1, Landroid/support/v7/widget/ah$a;->b:Landroid/support/v7/widget/RecyclerView$ItemAnimator$ItemHolderInfo;
    ...
    iget-object v4, v1, Landroid/support/v7/widget/ah$a;->c:Landroid/support/v7/widget/RecyclerView$ItemAnimator$ItemHolderInfo;

    invoke-interface {p1, v0, v3, v4}, Landroid/support/v7/widget/ah$b;->a(Landroid/support/v7/widget/RecyclerView$ViewHolder;Landroid/support/v7/widget/RecyclerView$ItemAnimator$ItemHolderInfo;Landroid/support/v7/widget/RecyclerView$ItemAnimator$ItemHolderInfo;)V
    ...
    invoke-interface {p1, v0, v3, v4}, Landroid/support/v7/widget/ah$b;->b(Landroid/support/v7/widget/RecyclerView$ViewHolder;Landroid/support/v7/widget/RecyclerView$ItemAnimator$ItemHolderInfo;Landroid/support/v7/widget/RecyclerView$ItemAnimator$ItemHolderInfo;)V
    ...
    invoke-interface {p1, v0, v3, v4}, Landroid/support/v7/widget/ah$b;->c(Landroid/support/v7/widget/RecyclerView$ViewHolder;Landroid/support/v7/widget/RecyclerView$ItemAnimator$ItemHolderInfo;Landroid/support/v7/widget/RecyclerView$ItemAnimator$ItemHolderInfo;)V
...
.method a(Landroid/support/v7/widget/RecyclerView$ViewHolder;)Z
    ...
    iget v0, v0, Landroid/support/v7/widget/ah$a;->a:I
...
.method g(Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ah;->b:Landroid/support/v4/f/f;
