...
# static fields
.field private static i:Landroid/support/v7/widget/af;
...
.method private constructor <init>(Landroid/view/View;Ljava/lang/CharSequence;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/af;->c:Ljava/lang/Runnable;
...
.method private a()V
    ...
    sput-object v2, Landroid/support/v7/widget/af;->j:Landroid/support/v7/widget/af;

    iget-object v0, p0, Landroid/support/v7/widget/af;->g:Landroid/support/v7/widget/ag;
    ...
    iput-object v2, p0, Landroid/support/v7/widget/af;->g:Landroid/support/v7/widget/ag;
    ...
    :cond_0
    :goto_0
    sget-object v0, Landroid/support/v7/widget/af;->i:Landroid/support/v7/widget/af;

    if-ne v0, p0, :cond_1

    invoke-static {v2}, Landroid/support/v7/widget/af;->b(Landroid/support/v7/widget/af;)V
...
.method static synthetic a(Landroid/support/v7/widget/af;)V
    .locals 0
...
.method static synthetic a(Landroid/support/v7/widget/af;Z)V
    .locals 0

    invoke-direct {p0, p1}, Landroid/support/v7/widget/af;->a(Z)V
...
.method public static a(Landroid/view/View;Ljava/lang/CharSequence;)V
    ...
    invoke-static {v1}, Landroid/support/v7/widget/af;->b(Landroid/support/v7/widget/af;)V
    ...
    invoke-direct {v0}, Landroid/support/v7/widget/af;->a()V
...
.method private a(Z)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/af;->a:Landroid/view/View;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/af;->g:Landroid/support/v7/widget/ag;
    ...
    iget-boolean v4, p0, Landroid/support/v7/widget/af;->h:Z

    iget-object v5, p0, Landroid/support/v7/widget/af;->b:Ljava/lang/CharSequence;

    invoke-virtual/range {v0 .. v5}, Landroid/support/v7/widget/ag;->a(Landroid/view/View;IIZLjava/lang/CharSequence;)V
    ...
    iget-object v3, p0, Landroid/support/v7/widget/af;->d:Ljava/lang/Runnable;
...
.method private b()V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/af;->c:Ljava/lang/Runnable;
...
.method private static b(Landroid/support/v7/widget/af;)V
    .locals 1
    ...
    :cond_0
    sput-object p0, Landroid/support/v7/widget/af;->i:Landroid/support/v7/widget/af;
    ...
    invoke-direct {v0}, Landroid/support/v7/widget/af;->b()V
...
.method public onHover(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    invoke-static {p0}, Landroid/support/v7/widget/af;->b(Landroid/support/v7/widget/af;)V
...
.method public onLongClick(Landroid/view/View;)Z
    ...
    invoke-direct {p0, v1}, Landroid/support/v7/widget/af;->a(Z)V
