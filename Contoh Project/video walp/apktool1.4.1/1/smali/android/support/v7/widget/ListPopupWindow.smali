...
.field mDropDownList:Landroid/support/v7/widget/r;
...
.method private buildDropDown()I
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->mDropDownList:Landroid/support/v7/widget/r;
    ...
    :goto_0
    invoke-virtual {p0, v5, v0}, Landroid/support/v7/widget/ListPopupWindow;->createDropDownListView(Landroid/content/Context;Z)Landroid/support/v7/widget/r;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->mDropDownList:Landroid/support/v7/widget/r;
    ...
    invoke-virtual {v0, v6}, Landroid/support/v7/widget/r;->setSelector(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v0, v6}, Landroid/support/v7/widget/r;->setAdapter(Landroid/widget/ListAdapter;)V
    ...
    invoke-virtual {v0, v6}, Landroid/support/v7/widget/r;->setOnItemClickListener(Landroid/widget/AdapterView$OnItemClickListener;)V
    ...
    invoke-virtual {v0, v6}, Landroid/support/v7/widget/r;->setOnItemSelectedListener(Landroid/widget/AdapterView$OnItemSelectedListener;)V
    ...
    invoke-virtual {v0, v6}, Landroid/support/v7/widget/r;->setOnScrollListener(Landroid/widget/AbsListView$OnScrollListener;)V
    ...
    invoke-virtual/range {v0 .. v5}, Landroid/support/v7/widget/r;->measureHeightOfChildrenCompat(IIIII)I

    move-result v0

    if-lez v0, :cond_9

    iget-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->mDropDownList:Landroid/support/v7/widget/r;

    invoke-virtual {v1}, Landroid/support/v7/widget/r;->getPaddingTop()I

    move-result v1

    iget-object v2, p0, Landroid/support/v7/widget/ListPopupWindow;->mDropDownList:Landroid/support/v7/widget/r;

    invoke-virtual {v2}, Landroid/support/v7/widget/r;->getPaddingBottom()I
...
.method createDropDownListView(Landroid/content/Context;Z)Landroid/support/v7/widget/r;
    .locals 1
...
.method public dismiss()V
    ...
    iput-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->mDropDownList:Landroid/support/v7/widget/r;
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    :cond_5
    iget-object v4, p0, Landroid/support/v7/widget/ListPopupWindow;->mDropDownList:Landroid/support/v7/widget/r;

    invoke-virtual {v4, v2, v1}, Landroid/support/v7/widget/r;->lookForSelectablePosition(IZ)I
    ...
    :cond_6
    iget-object v3, p0, Landroid/support/v7/widget/ListPopupWindow;->mDropDownList:Landroid/support/v7/widget/r;
    ...
    invoke-virtual {v3, v6, v2}, Landroid/support/v7/widget/r;->lookForSelectablePosition(IZ)I
    ...
    :cond_7
    iget-object v6, p0, Landroid/support/v7/widget/ListPopupWindow;->mDropDownList:Landroid/support/v7/widget/r;

    invoke-virtual {v6, v2}, Landroid/support/v7/widget/r;->setListSelectionHidden(Z)V

    iget-object v6, p0, Landroid/support/v7/widget/ListPopupWindow;->mDropDownList:Landroid/support/v7/widget/r;

    invoke-virtual {v6, p1, p2}, Landroid/support/v7/widget/r;->onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/r;->requestFocusFromTouch()Z
...
.method public performItemClick(I)Z
    ...
    invoke-virtual {v1}, Landroid/support/v7/widget/r;->getFirstVisiblePosition()I

    move-result v0

    sub-int v0, p1, v0

    invoke-virtual {v1, v0}, Landroid/support/v7/widget/r;->getChildAt(I)Landroid/view/View;

    move-result-object v2

    invoke-virtual {v1}, Landroid/support/v7/widget/r;->getAdapter()Landroid/widget/ListAdapter;
...
.method public show()V
    ...
    invoke-static {v0, v4}, Landroid/support/v4/widget/m;->a(Landroid/widget/PopupWindow;I)V
