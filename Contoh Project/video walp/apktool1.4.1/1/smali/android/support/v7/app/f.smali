...
.field private w:Landroid/support/v7/app/f$b;
...
.method constructor <init>(Landroid/content/Context;Landroid/view/Window;Landroid/support/v7/app/b;)V
    ...
    iput v0, p0, Landroid/support/v7/app/f;->t:I

    const/4 v0, 0x1

    iput-boolean v0, p0, Landroid/support/v7/app/f;->v:Z
...
.method private h(I)Z
    ...
    invoke-direct {p0}, Landroid/support/v7/app/f;->y()Z
    ...
    invoke-static {v1}, Landroid/support/v7/app/i;->a(Landroid/content/res/Resources;)Z
...
.method private x()V
    ...
    iget-object v0, p0, Landroid/support/v7/app/f;->w:Landroid/support/v7/app/f$b;
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/v7/app/f$b;-><init>(Landroid/support/v7/app/f;Landroid/support/v7/app/l;)V

    iput-object v0, p0, Landroid/support/v7/app/f;->w:Landroid/support/v7/app/f$b;
...
.method private y()Z
    ...
    iget-boolean v2, p0, Landroid/support/v7/app/f;->u:Z

    if-eqz v2, :cond_1

    iget-object v2, p0, Landroid/support/v7/app/f;->a:Landroid/content/Context;
...
.method public c(Landroid/os/Bundle;)V
    ...
    iget v1, p0, Landroid/support/v7/app/f;->t:I
...
.method d(I)I
    ...
    invoke-virtual {v0}, Landroid/support/v7/app/f$b;->a()I
...
.method public d()V
    ...
    invoke-virtual {v0}, Landroid/support/v7/app/f$b;->d()V
...
.method public i()Z
    ...
    invoke-direct {p0}, Landroid/support/v7/app/f;->w()I

    move-result v1

    invoke-virtual {p0, v1}, Landroid/support/v7/app/f;->d(I)I
    ...
    invoke-direct {p0, v2}, Landroid/support/v7/app/f;->h(I)Z
    ...
    iget-object v1, p0, Landroid/support/v7/app/f;->w:Landroid/support/v7/app/f$b;

    invoke-virtual {v1}, Landroid/support/v7/app/f$b;->c()V

    :cond_1
    const/4 v1, 0x1

    iput-boolean v1, p0, Landroid/support/v7/app/f;->u:Z
