...
.field private final f:Landroid/support/v7/widget/k;
...
.method constructor <init>(Landroid/widget/TextView;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/i;->a:Landroid/widget/TextView;

    new-instance v0, Landroid/support/v7/widget/k;

    iget-object v1, p0, Landroid/support/v7/widget/i;->a:Landroid/widget/TextView;

    invoke-direct {v0, v1}, Landroid/support/v7/widget/k;-><init>(Landroid/widget/TextView;)V

    iput-object v0, p0, Landroid/support/v7/widget/i;->f:Landroid/support/v7/widget/k;

    return-void
.end method

.method protected static a(Landroid/content/Context;Landroid/support/v7/widget/AppCompatDrawableManager;I)Landroid/support/v7/widget/ad;
    .locals 3
...
.method static a(Landroid/widget/TextView;)Landroid/support/v7/widget/i;
    .locals 2
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/widget/i;-><init>(Landroid/widget/TextView;)V
...
.method private a(Landroid/content/Context;Landroid/support/v7/widget/TintTypedArray;)V
    ...
    iget v3, p0, Landroid/support/v7/widget/i;->g:I
    ...
    iput-object v0, p0, Landroid/support/v7/widget/i;->h:Landroid/graphics/Typeface;
    ...
    iget-object v4, p0, Landroid/support/v7/widget/i;->a:Landroid/widget/TextView;

    invoke-direct {v3, v4}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    new-instance v4, Landroid/support/v7/widget/i$1;

    invoke-direct {v4, p0, v3}, Landroid/support/v7/widget/i$1;-><init>(Landroid/support/v7/widget/i;Ljava/lang/ref/WeakReference;)V
    ...
    iput-object v3, p0, Landroid/support/v7/widget/i;->h:Landroid/graphics/Typeface;

    iget-object v3, p0, Landroid/support/v7/widget/i;->h:Landroid/graphics/Typeface;

    if-nez v3, :cond_4

    :goto_1
    iput-boolean v1, p0, Landroid/support/v7/widget/i;->i:Z
    :try_end_0
    ...
    :cond_1
    :goto_2
    iget-object v1, p0, Landroid/support/v7/widget/i;->h:Landroid/graphics/Typeface;
    ...
    iget v1, p0, Landroid/support/v7/widget/i;->g:I
    ...
    iput-boolean v2, p0, Landroid/support/v7/widget/i;->i:Z
...
.method static synthetic a(Landroid/support/v7/widget/i;Ljava/lang/ref/WeakReference;Landroid/graphics/Typeface;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/i;->a(Ljava/lang/ref/WeakReference;Landroid/graphics/Typeface;)V
...
.method private a(Ljava/lang/ref/WeakReference;Landroid/graphics/Typeface;)V
    ...
    iput-object p2, p0, Landroid/support/v7/widget/i;->h:Landroid/graphics/Typeface;
...
.method private b(IF)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/i;->f:Landroid/support/v7/widget/k;
...
.method a()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/i;->b:Landroid/support/v7/widget/ad;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/i;->c:Landroid/support/v7/widget/ad;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/i;->d:Landroid/support/v7/widget/ad;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/i;->e:Landroid/support/v7/widget/ad;

    if-eqz v0, :cond_1

    :cond_0
    iget-object v0, p0, Landroid/support/v7/widget/i;->a:Landroid/widget/TextView;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/i;->b:Landroid/support/v7/widget/ad;

    invoke-virtual {p0, v1, v2}, Landroid/support/v7/widget/i;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/ad;)V

    const/4 v1, 0x1

    aget-object v1, v0, v1

    iget-object v2, p0, Landroid/support/v7/widget/i;->c:Landroid/support/v7/widget/ad;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/i;->d:Landroid/support/v7/widget/ad;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/i;->e:Landroid/support/v7/widget/ad;

    invoke-virtual {p0, v0, v1}, Landroid/support/v7/widget/i;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/ad;)V
...
.method a(IF)V
    ...
    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/i;->b(IF)V
...
.method a(Landroid/content/Context;I)V
    ...
    invoke-virtual {p0, v1}, Landroid/support/v7/widget/i;->a(Z)V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/i;->a:Landroid/widget/TextView;

    invoke-virtual {v2, v1}, Landroid/widget/TextView;->setTextColor(Landroid/content/res/ColorStateList;)V

    :cond_1
    invoke-direct {p0, p1, v0}, Landroid/support/v7/widget/i;->a(Landroid/content/Context;Landroid/support/v7/widget/TintTypedArray;)V

    invoke-virtual {v0}, Landroid/support/v7/widget/TintTypedArray;->recycle()V

    iget-object v0, p0, Landroid/support/v7/widget/i;->h:Landroid/graphics/Typeface;
...
.method final a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/ad;)V
    .locals 1
    ...
    invoke-static {p1, p2, v0}, Landroid/support/v7/widget/AppCompatDrawableManager;->tintDrawable(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/ad;[I)V
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v7, v0, v6}, Landroid/support/v7/widget/i;->a(Landroid/content/Context;Landroid/support/v7/widget/AppCompatDrawableManager;I)Landroid/support/v7/widget/ad;

    move-result-object v6

    iput-object v6, p0, Landroid/support/v7/widget/i;->b:Landroid/support/v7/widget/ad;
    ...
    iput-object v6, p0, Landroid/support/v7/widget/i;->c:Landroid/support/v7/widget/ad;
    ...
    iput-object v6, p0, Landroid/support/v7/widget/i;->d:Landroid/support/v7/widget/ad;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/i;->e:Landroid/support/v7/widget/ad;
    ...
    :goto_0
    invoke-direct {p0, v7, v9}, Landroid/support/v7/widget/i;->a(Landroid/content/Context;Landroid/support/v7/widget/TintTypedArray;)V
    ...
    invoke-virtual {p0, v3}, Landroid/support/v7/widget/i;->a(Z)V
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v7/widget/k;->a(Landroid/util/AttributeSet;I)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/i;->f:Landroid/support/v7/widget/k;

    invoke-virtual {v1}, Landroid/support/v7/widget/k;->c()I

    move-result v1

    iget-object v3, p0, Landroid/support/v7/widget/i;->f:Landroid/support/v7/widget/k;

    invoke-virtual {v3}, Landroid/support/v7/widget/k;->d()I

    move-result v3

    iget-object v4, p0, Landroid/support/v7/widget/i;->f:Landroid/support/v7/widget/k;
