...
.field private static q:Landroid/support/transition/z;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/transition/ChangeBounds;->q:Landroid/support/transition/z;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object v0, Landroid/support/transition/ac;->d:[I
...
.method private a(Landroid/view/View;Landroid/view/View;)Z
    ...
    invoke-virtual {p0, p1, v0}, Landroid/support/transition/ChangeBounds;->b(Landroid/view/View;Z)Landroid/support/transition/ah;
...
.method private d(Landroid/support/transition/ah;)V
    ...
    iget-object v3, p1, Landroid/support/transition/ah;->b:Landroid/view/View;
...
.method public a(Landroid/view/ViewGroup;Landroid/support/transition/ah;Landroid/support/transition/ah;)Landroid/animation/Animator;
    ...
    iget-object v1, v0, Landroid/support/transition/ah;->a:Ljava/util/Map;

    move-object/from16 v0, p3

    iget-object v2, v0, Landroid/support/transition/ah;->a:Ljava/util/Map;
    ...
    invoke-static {v3, v9, v10, v11, v12}, Landroid/support/transition/au;->a(Landroid/view/View;IIII)V
    ...
    invoke-static {v3, v2, v1}, Landroid/support/transition/p;->a(Ljava/lang/Object;Landroid/util/Property;Landroid/graphics/Path;)Landroid/animation/ObjectAnimator;
    ...
    invoke-static {v1, v3}, Landroid/support/transition/an;->a(Landroid/view/ViewGroup;Z)V
    ...
    invoke-static {v2, v4, v1}, Landroid/support/transition/p;->a(Ljava/lang/Object;Landroid/util/Property;Landroid/graphics/Path;)Landroid/animation/ObjectAnimator;
    ...
    invoke-static {v2, v5, v1}, Landroid/support/transition/p;->a(Ljava/lang/Object;Landroid/util/Property;Landroid/graphics/Path;)Landroid/animation/ObjectAnimator;
    ...
    invoke-static {v3, v9, v10, v2, v11}, Landroid/support/transition/au;->a(Landroid/view/View;IIII)V
    ...
    invoke-static {v3, v9, v2}, Landroid/support/transition/p;->a(Ljava/lang/Object;Landroid/util/Property;Landroid/graphics/Path;)Landroid/animation/ObjectAnimator;
    ...
    sget-object v11, Landroid/support/transition/ChangeBounds;->q:Landroid/support/transition/z;
    ...
    :goto_5
    invoke-static {v10, v1}, Landroid/support/transition/ag;->a(Landroid/animation/Animator;Landroid/animation/Animator;)Landroid/animation/Animator;
    ...
    invoke-static {v3}, Landroid/support/transition/au;->c(Landroid/view/View;)F

    move-result v9

    const/4 v6, 0x0

    invoke-static {v3, v6}, Landroid/support/transition/au;->a(Landroid/view/View;F)V

    invoke-static/range {p1 .. p1}, Landroid/support/transition/au;->a(Landroid/view/View;)Landroid/support/transition/at;

    move-result-object v6

    invoke-interface {v6, v7}, Landroid/support/transition/at;->a(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {v2, v1}, Landroid/support/transition/u;->a(Landroid/util/Property;Landroid/graphics/Path;)Landroid/animation/PropertyValuesHolder;
...
.method public a(Landroid/support/transition/ah;)V
    ...
    invoke-direct {p0, p1}, Landroid/support/transition/ChangeBounds;->d(Landroid/support/transition/ah;)V
