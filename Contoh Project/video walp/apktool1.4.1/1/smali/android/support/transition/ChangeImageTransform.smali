...
.method private a(Landroid/widget/ImageView;Landroid/graphics/Matrix;Landroid/graphics/Matrix;)Landroid/animation/ObjectAnimator;
    ...
    new-instance v1, Landroid/support/transition/ag$a;

    invoke-direct {v1}, Landroid/support/transition/ag$a;-><init>()V
...
.method public a(Landroid/view/ViewGroup;Landroid/support/transition/ah;Landroid/support/transition/ah;)Landroid/animation/Animator;
    ...
    :cond_3
    iget-object v2, p2, Landroid/support/transition/ah;->a:Ljava/util/Map;
    ...
    iget-object v3, p3, Landroid/support/transition/ah;->a:Ljava/util/Map;
    ...
    :cond_7
    iget-object v0, p3, Landroid/support/transition/ah;->b:Landroid/view/View;
    ...
    invoke-static {v0}, Landroid/support/transition/k;->a(Landroid/widget/ImageView;)V
    ...
    :goto_2
    invoke-static {v0, v1}, Landroid/support/transition/k;->a(Landroid/widget/ImageView;Landroid/animation/Animator;)V
    ...
    sget-object v2, Landroid/support/transition/o;->a:Landroid/graphics/Matrix;
...
.method public a(Landroid/support/transition/ah;)V
    ...
    invoke-direct {p0, p1}, Landroid/support/transition/ChangeImageTransform;->d(Landroid/support/transition/ah;)V
