...
.method private static a(Landroid/animation/LayoutTransition;)V
    ...
    sget-boolean v0, Landroid/support/transition/ao;->e:Z
    ...
    sput-object v0, Landroid/support/transition/ao;->d:Ljava/lang/reflect/Method;

    sget-object v0, Landroid/support/transition/ao;->d:Ljava/lang/reflect/Method;
    ...
    :goto_0
    sput-boolean v3, Landroid/support/transition/ao;->e:Z
...
# virtual methods
.method public a(Landroid/view/ViewGroup;)Landroid/support/transition/am;
    .locals 1

    invoke-static {p1}, Landroid/support/transition/ak;->a(Landroid/view/ViewGroup;)Landroid/support/transition/ak;
...
.method public a(Landroid/view/ViewGroup;Z)V
    ...
    sget-object v1, Landroid/support/transition/ao;->a:Landroid/animation/LayoutTransition;

    if-nez v1, :cond_0

    new-instance v1, Landroid/support/transition/ao$1;

    invoke-direct {v1, p0}, Landroid/support/transition/ao$1;-><init>(Landroid/support/transition/ao;)V

    sput-object v1, Landroid/support/transition/ao;->a:Landroid/animation/LayoutTransition;
    ...
    invoke-static {v0}, Landroid/support/transition/ao;->a(Landroid/animation/LayoutTransition;)V
    ...
    sget v1, Landroid/support/transition/y$a;->transition_layout_save:I

    invoke-virtual {p1, v1, v0}, Landroid/view/ViewGroup;->setTag(ILjava/lang/Object;)V

    :cond_2
    sget-object v0, Landroid/support/transition/ao;->a:Landroid/animation/LayoutTransition;
    ...
    sget-boolean v1, Landroid/support/transition/ao;->c:Z
    ...
    sput-object v1, Landroid/support/transition/ao;->b:Ljava/lang/reflect/Field;

    sget-object v1, Landroid/support/transition/ao;->b:Ljava/lang/reflect/Field;
    ...
    :goto_1
    sput-boolean v4, Landroid/support/transition/ao;->c:Z
    ...
    :cond_7
    sget v0, Landroid/support/transition/y$a;->transition_layout_save:I
