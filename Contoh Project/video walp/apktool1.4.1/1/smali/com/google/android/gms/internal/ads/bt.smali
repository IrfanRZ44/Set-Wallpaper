...
.method public final synthetic a(Lcom/google/android/gms/internal/ads/ay;Lorg/json/JSONObject;)Lcom/google/android/gms/internal/ads/att;
    ...
    new-instance v7, Landroid/support/v4/f/m;

    invoke-direct {v7}, Landroid/support/v4/f/m;-><init>()V
    ...
    invoke-virtual {p1, p2, v0}, Lcom/google/android/gms/internal/ads/ay;->a(Lorg/json/JSONObject;Ljava/lang/String;)Lcom/google/android/gms/internal/ads/ne;
    ...
    invoke-virtual {v3, v9, v1}, Landroid/support/v4/f/m;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v7, v9, v1}, Landroid/support/v4/f/m;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v2}, Landroid/support/v4/f/m;-><init>()V

    move v5, v4

    :goto_3
    invoke-virtual {v7}, Landroid/support/v4/f/m;->size()I

    move-result v4

    if-ge v5, v4, :cond_4

    invoke-virtual {v7, v5}, Landroid/support/v4/f/m;->b(I)Ljava/lang/Object;

    move-result-object v10

    invoke-virtual {v7, v5}, Landroid/support/v4/f/m;->c(I)Ljava/lang/Object;
    ...
    invoke-virtual {v2, v10, v4}, Landroid/support/v4/f/m;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {v9}, Lcom/google/android/gms/internal/ads/qe;->b()Lcom/google/android/gms/internal/ads/qu;
    ...
    invoke-interface {v9}, Lcom/google/android/gms/internal/ads/qe;->getView()Landroid/view/View;

    move-result-object v6

    :cond_5
    invoke-direct/range {v0 .. v6}, Lcom/google/android/gms/internal/ads/atj;-><init>(Ljava/lang/String;Landroid/support/v4/f/m;Landroid/support/v4/f/m;Lcom/google/android/gms/internal/ads/ata;Lcom/google/android/gms/internal/ads/aqg;Landroid/view/View;)V
