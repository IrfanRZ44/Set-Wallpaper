  ...
  implements android.support.v4.b.a.a
{
  ...
  private void a(int paramInt1, CharSequence paramCharSequence, int paramInt2, Drawable paramDrawable, View paramView)
  {
    ...
    if (paramInt1 > 0)
    {
      ...
      this.b = android.support.v4.content.a.getDrawable(e(), paramInt2);
    }
    for (;;)
    {
      this.c = null;
  ...
  private void e(Bundle paramBundle)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      else
      {
        ...
        if (i1 > 0)
        {
          Parcelable localParcelable = localo.c();
  ...
  {
    int i1 = 1;
    if ((paramBoolean) && (this.f.getConfiguration().keyboard != i1) && (this.f.getBoolean(a.b.abc_config_showMenuShortcutsWhenKeyboardPresent))) {}
    for (;;)
    {
      this.h = i1;
      return;
  ...
  void a(MenuItem paramMenuItem)
  {
    ...
    if (i3 < i2)
    {
      ...
      if ((localj.getGroupId() != i1) || (!localj.g())) {}
  ...
  public boolean a(MenuItem paramMenuItem, o paramo, int paramInt)
  {
    ...
    do
    {
      ...
      bool3 = localj.b();
      b localb = localj.a();
      if ((localb != null) && (localb.hasSubMenu())) {}
      for (int i1 = 1;; i1 = 0)
      {
        if (!localj.n()) {
          break label99;
      ...
      if (!localj.hasSubMenu()) {
        localj.a(new u(e(), this, localj));
      }
      u localu = (u)localj.getSubMenu();
      if (i1 != 0) {
        localb.onPrepareSubMenu(localu);
      }
  ...
  public void j()
  {
    ...
    if (localIterator.hasNext())
    {
      ...
      for (boolean bool2 = bool1;; bool2 = bool1 | localo.a())
      {
        bool1 = bool2;
        break;
      }
