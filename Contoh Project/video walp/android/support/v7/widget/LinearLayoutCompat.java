  ...
  extends ViewGroup
{
  ...
  public LinearLayoutCompat(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    TintTypedArray localTintTypedArray = TintTypedArray.obtainStyledAttributes(paramContext, paramAttributeSet, a.j.LinearLayoutCompat, paramInt, 0);
    int i = localTintTypedArray.getInt(a.j.LinearLayoutCompat_android_orientation, -1);
    if (i >= 0) {
      setOrientation(i);
    }
    int j = localTintTypedArray.getInt(a.j.LinearLayoutCompat_android_gravity, -1);
    if (j >= 0) {
      setGravity(j);
    }
    boolean bool = localTintTypedArray.getBoolean(a.j.LinearLayoutCompat_android_baselineAligned, true);
    if (!bool) {
      setBaselineAligned(bool);
    }
    this.mWeightSum = localTintTypedArray.getFloat(a.j.LinearLayoutCompat_android_weightSum, -1.0F);
    this.mBaselineAlignedChildIndex = localTintTypedArray.getInt(a.j.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
    this.mUseLargestChild = localTintTypedArray.getBoolean(a.j.LinearLayoutCompat_measureWithLargestChild, false);
    setDividerDrawable(localTintTypedArray.getDrawable(a.j.LinearLayoutCompat_divider));
    this.mShowDividers = localTintTypedArray.getInt(a.j.LinearLayoutCompat_showDividers, 0);
    this.mDividerPadding = localTintTypedArray.getDimensionPixelSize(a.j.LinearLayoutCompat_dividerPadding, 0);
    ...
    extends ViewGroup.MarginLayoutParams
  {
    ...
    public LayoutParams(Context paramContext, AttributeSet paramAttributeSet)
    {
      ...
      this.weight = localTypedArray.getFloat(a.j.LinearLayoutCompat_Layout_android_layout_weight, 0.0F);
      this.gravity = localTypedArray.getInt(a.j.LinearLayoutCompat_Layout_android_layout_gravity, -1);
