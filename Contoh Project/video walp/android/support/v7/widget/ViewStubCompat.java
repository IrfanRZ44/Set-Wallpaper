  ...
  extends View
{
  ...
  public ViewStubCompat(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.mInflatedId = localTypedArray.getResourceId(a.j.ViewStubCompat_android_inflatedId, -1);
    this.mLayoutResource = localTypedArray.getResourceId(a.j.ViewStubCompat_android_layout, 0);
