  ...
  implements h.b, p
{
  ...
  public Menu getMenu()
  {
    ...
    label109:
    for (Object localObject = this.mActionMenuPresenterCallback;; localObject = new a())
    {
  ...
  {
    return (this.mPresenter != null) && (this.mPresenter.g());
  }
  ...
  {
    return (this.mPresenter != null) && (this.mPresenter.k());
  }
  ...
  {
    this.mPresenter.d(paramBoolean);
  }
  ...
  {
    return (this.mPresenter != null) && (this.mPresenter.f());
  }
