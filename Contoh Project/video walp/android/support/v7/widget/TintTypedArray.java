...
public class TintTypedArray
{
  ...
  public ColorStateList getColorStateList(int paramInt)
  {
    if (this.mWrapped.hasValue(paramInt))
    {
      ...
      if (i != 0)
      {
        ColorStateList localColorStateList = android.support.v7.c.a.b.a(this.mContext, i);
  ...
  public Drawable getDrawable(int paramInt)
  {
    if (this.mWrapped.hasValue(paramInt))
    {
      int i = this.mWrapped.getResourceId(paramInt, 0);
      if (i != 0) {
        return android.support.v7.c.a.b.b(this.mContext, i);
      }
    }
  ...
  public Typeface getFont(int paramInt1, int paramInt2, b.a parama)
  {
    ...
    return android.support.v4.content.a.b.a(this.mContext, i, this.mTypedValue, paramInt2, parama);
  }
