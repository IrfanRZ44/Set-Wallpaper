  ...
  implements View.OnAttachStateChangeListener, View.OnTouchListener
{
  ...
  private boolean onTouchForwarded(MotionEvent paramMotionEvent)
  {
    ...
    {
      return false;
      localr = (r)locals.getListView();
    } while ((localr == null) || (!localr.isShown()));
    MotionEvent localMotionEvent = MotionEvent.obtainNoHistory(paramMotionEvent);
    toGlobalMotionEvent(localView, localMotionEvent);
    toLocalMotionEvent(localr, localMotionEvent);
    boolean bool1 = localr.onForwardedEvent(localMotionEvent, this.mActivePointerId);
