  ...
  implements j
{
  ...
  private final ah.b mViewInfoProcessCallback;
  final ah mViewInfoStore = new ah();
  ...
  public RecyclerView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    if (ALLOW_THREAD_GAP_WORK)
    {
      ...
      this.mViewInfoProcessCallback = new ah.b()
      {
      ...
      this.mScaledHorizontalScrollFactor = android.support.v4.view.t.a(localViewConfiguration, paramContext);
      this.mScaledVerticalScrollFactor = android.support.v4.view.t.b(localViewConfiguration, paramContext);
      ...
      if (android.support.v4.view.s.d(this) == 0) {
        android.support.v4.view.s.a(this, i);
      }
      ...
      TypedArray localTypedArray1 = paramContext.obtainStyledAttributes(paramAttributeSet, a.c.RecyclerView, paramInt, 0);
      String str = localTypedArray1.getString(a.c.RecyclerView_layoutManager);
      if (localTypedArray1.getInt(a.c.RecyclerView_android_descendantFocusability, -1) == -1) {
        setDescendantFocusability(262144);
      }
      this.mEnableFastScroller = localTypedArray1.getBoolean(a.c.RecyclerView_fastScrollEnabled, false);
      if (this.mEnableFastScroller) {
        initFastScroller((StateListDrawable)localTypedArray1.getDrawable(a.c.RecyclerView_fastScrollVerticalThumbDrawable), localTypedArray1.getDrawable(a.c.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable)localTypedArray1.getDrawable(a.c.RecyclerView_fastScrollHorizontalThumbDrawable), localTypedArray1.getDrawable(a.c.RecyclerView_fastScrollHorizontalTrackDrawable));
      }
  ...
  private void dispatchLayoutStep1()
  {
    ...
    if ((this.mState.mRunSimpleAnimations) && (this.mItemsChanged))
    {
      ...
      int m = this.mChildHelper.b();
      n = 0;
      if (n >= m) {
        break label302;
      }
      localViewHolder2 = getChildViewHolderInt(this.mChildHelper.b(n));
    ...
    for (;;)
    {
      ...
      this.mViewInfoStore.a(localViewHolder2, localItemHolderInfo2);
      if ((this.mState.mTrackOldChangeHolders) && (localViewHolder2.isUpdated()) && (!localViewHolder2.isRemoved()) && (!localViewHolder2.shouldIgnore()) && (!localViewHolder2.isInvalid()))
      {
        ...
        this.mViewInfoStore.a(l, localViewHolder2);
      }
    }
    label302:
    if (this.mState.mRunPredictiveAnimations)
    {
      ...
      int j = 0;
      if (j < this.mChildHelper.b())
      {
        ViewHolder localViewHolder1 = getChildViewHolderInt(this.mChildHelper.b(j));
        if (localViewHolder1.shouldIgnore()) {}
        for (;;)
        {
          j++;
          break;
          if (!this.mViewInfoStore.d(localViewHolder1))
          {
            ...
            if (bool2) {
              ...
              this.mViewInfoStore.b(localViewHolder1, localItemHolderInfo1);
            }
          }
        }
      }
      ...
      if (i >= 0)
      {
        ...
        for (;;)
        {
          ...
          if ((localViewHolder2 != null) && (!localViewHolder2.shouldIgnore()))
          {
            ...
            {
              this.mViewInfoStore.c(localViewHolder1, localItemHolderInfo1);
            }
            else
            {
              RecyclerView.ItemAnimator.ItemHolderInfo localItemHolderInfo2 = this.mViewInfoStore.b(localViewHolder2);
              this.mViewInfoStore.c(localViewHolder1, localItemHolderInfo1);
              RecyclerView.ItemAnimator.ItemHolderInfo localItemHolderInfo3 = this.mViewInfoStore.c(localViewHolder1);
  ...
  private void findMinMaxChildLayoutPositions(int[] paramArrayOfInt)
  {
    ...
    if (m < i)
    {
      localViewHolder = getChildViewHolderInt(this.mChildHelper.b(m));
  ...
  private k getScrollingChildHelper()
  {
    if (this.mScrollingChildHelper == null) {
      this.mScrollingChildHelper = new k(this);
    }
  ...
  {
    this.mChildHelper = new q(new q.b()
    {
      public int a()
      {
      ...
      {
        View localView = b(paramAnonymousInt);
        if (localView != null)
        {
  ...
  private void pullGlows(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4)
  {
    ...
    {
      ensureLeftGlow();
      i.a(this.mLeftGlow, -paramFloat2 / getWidth(), 1.0F - paramFloat3 / getHeight());
      j = i;
      if (paramFloat4 >= 0.0F) {
        break label143;
      }
      ensureTopGlow();
      i.a(this.mTopGlow, -paramFloat4 / getHeight(), paramFloat1 / getWidth());
    }
    for (;;)
    {
      ...
      ensureRightGlow();
      i.a(this.mRightGlow, paramFloat2 / getWidth(), paramFloat3 / getHeight());
      j = i;
      break;
      label143:
      if (paramFloat4 > 0.0F)
      {
        ensureBottomGlow();
        i.a(this.mBottomGlow, paramFloat4 / getHeight(), 1.0F - paramFloat1 / getWidth());
      }
      else
      {
        i = j;
  ...
  private void recoverFocusFromState()
  {
    ...
    } while (!this.mChildHelper.c(localView3));
    ...
    for (ViewHolder localViewHolder = findViewHolderForItemId(this.mState.mFocusedItemId);; localViewHolder = null)
    {
      ...
      label195:
      View localView2;
      if ((localViewHolder == null) || (this.mChildHelper.c(localViewHolder.itemView)) || (!localViewHolder.itemView.hasFocusable()))
      {
        int i = this.mChildHelper.b();
        localView1 = null;
        if (i > 0) {
  ...
  {
    setMeasuredDimension(LayoutManager.chooseSize(paramInt1, getPaddingLeft() + getPaddingRight(), android.support.v4.view.s.i(this)), LayoutManager.chooseSize(paramInt2, getPaddingTop() + getPaddingBottom(), android.support.v4.view.s.j(this)));
  }
  ...
  void dispatchPendingImportantForAccessibilityChanges()
  {
    ...
    if (i >= 0)
    {
      ...
      for (;;)
      {
        ...
        if (j != -1)
        {
          android.support.v4.view.s.a(localViewHolder.itemView, j);
  ...
  {
    for (int i = -1 + this.mChildHelper.b(); i >= 0; i--)
    {
  ...
  public ViewHolder findViewHolderForAdapterPosition(int paramInt)
  {
    ...
    do
    {
      ...
      localObject1 = getChildViewHolderInt(this.mChildHelper.d(j));
      if ((localObject1 == null) || (((ViewHolder)localObject1).isRemoved()) || (getAdapterPositionFor((ViewHolder)localObject1) != paramInt)) {
        break label94;
      }
    } while (!this.mChildHelper.c(((ViewHolder)localObject1).itemView));
    for (;;)
    {
      j++;
  ...
  ViewHolder findViewHolderForPosition(int paramInt, boolean paramBoolean)
  {
    ...
    if (j < i)
    {
      localObject2 = getChildViewHolderInt(this.mChildHelper.d(j));
      ...
      for (;;)
      {
        ...
        {
          label75:
          if (!this.mChildHelper.c(((ViewHolder)localObject2).itemView)) {
            break label101;
          }
          localObject1 = localObject2;
        }
  ...
  {
    this.mAdapterHelper = new c(new c.a()
    {
      public RecyclerView.ViewHolder a(int paramAnonymousInt)
      {
        ...
        if (localViewHolder == null) {}
        while (RecyclerView.this.mChildHelper.c(localViewHolder.itemView)) {
          return null;
        }
  ...
  void initFastScroller(StateListDrawable paramStateListDrawable1, Drawable paramDrawable1, StateListDrawable paramStateListDrawable2, Drawable paramDrawable2)
  {
    ...
    new s(this, paramStateListDrawable1, paramDrawable1, paramStateListDrawable2, paramDrawable2, localResources.getDimensionPixelSize(a.a.fastscroll_default_thickness), localResources.getDimensionPixelSize(a.a.fastscroll_minimum_range), localResources.getDimensionPixelOffset(a.a.fastscroll_margin));
  }
  ...
  void offsetPositionRecordsForMove(int paramInt1, int paramInt2)
  {
    ...
    for (int m = paramInt1;; m = paramInt2)
    {
      for (int n = 0;; n++)
      {
        ...
        localViewHolder = getChildViewHolderInt(this.mChildHelper.d(n));
  ...
  void offsetPositionRecordsForRemove(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if (k < j)
    {
      ViewHolder localViewHolder = getChildViewHolderInt(this.mChildHelper.d(k));
      if ((localViewHolder != null) && (!localViewHolder.shouldIgnore()))
      {
  ...
  protected void onAttachedToWindow()
  {
    ...
    if ((this.mFirstLayoutComplete) && (!isLayoutRequested()))
    {
      ...
      if (ALLOW_THREAD_GAP_WORK)
      {
        this.mGapWorker = ((t)t.a.get());
        if (this.mGapWorker == null)
        {
          this.mGapWorker = new t();
          Display localDisplay = android.support.v4.view.s.C(this);
    ...
    for (;;)
    {
      this.mGapWorker.d = ((1.0E+009F / f));
      t.a.set(this.mGapWorker);
  ...
  {
    startInterceptRequestLayout();
    boolean bool1 = this.mChildHelper.f(paramView);
    if (bool1)
    {
      ViewHolder localViewHolder = getChildViewHolderInt(paramView);
  ...
  void repositionShadowingViews()
  {
    ...
    for (int j = 0; j < i; j++)
    {
      View localView1 = this.mChildHelper.b(j);
  ...
  boolean scrollByInternal(int paramInt1, int paramInt2, MotionEvent paramMotionEvent)
  {
    ...
    if (this.mAdapter != null)
    {
      ...
      if (paramInt1 != 0)
      {
        ...
        if (paramInt2 != 0)
        {
          i1 = this.mLayout.scrollVerticallyBy(paramInt2, this.mRecycler, this.mState);
          i2 = paramInt2 - i1;
          android.support.v4.os.c.a();
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (getOverScrollMode() != 2)
        {
          if ((paramMotionEvent != null) && (!h.a(paramMotionEvent, 8194))) {
  ...
  boolean setChildImportantForAccessibilityInternal(ViewHolder paramViewHolder, int paramInt)
  {
    ...
    android.support.v4.view.s.a(paramViewHolder.itemView, paramInt);
    return true;
  }
  ...
  boolean shouldDeferAccessibilityEvent(AccessibilityEvent paramAccessibilityEvent)
  {
    ...
    label51:
    for (int i = a.a(paramAccessibilityEvent);; i = 0)
    {
      int j = 0;
      if (i == 0) {}
      for (;;)
  ...
  public void smoothScrollBy(int paramInt1, int paramInt2, Interpolator paramInterpolator)
  {
    ...
    for (;;)
    {
      ...
      if (!this.mLayoutFrozen)
      {
        ...
        {
          this.mViewFlinger.a(paramInt1, i, paramInterpolator);
          return;
          i = paramInt2;
        }
      }
  ...
  void viewRangeUpdate(int paramInt1, int paramInt2, Object paramObject)
  {
    ...
    if (k < i)
    {
      View localView = this.mChildHelper.d(k);
  ...
  public static abstract class LayoutManager
  {
    ...
    private int[] getChildRectangleOnScreenScrollAmount(RecyclerView paramRecyclerView, View paramView, Rect paramRect, boolean paramBoolean)
    {
      ...
      label220:
      for (int i10 = i5;; i10 = Math.min(i1 - j, i7))
      {
        arrayOfInt[0] = i9;
        arrayOfInt[1] = i10;
        return arrayOfInt;
    ...
    public static Properties getProperties(Context paramContext, AttributeSet paramAttributeSet, int paramInt1, int paramInt2)
    {
      ...
      TypedArray localTypedArray = paramContext.obtainStyledAttributes(paramAttributeSet, a.c.RecyclerView, paramInt1, paramInt2);
      localProperties.orientation = localTypedArray.getInt(a.c.RecyclerView_android_orientation, 1);
      localProperties.spanCount = localTypedArray.getInt(a.c.RecyclerView_spanCount, 1);
      localProperties.reverseLayout = localTypedArray.getBoolean(a.c.RecyclerView_reverseLayout, false);
      localProperties.stackFromEnd = localTypedArray.getBoolean(a.c.RecyclerView_stackFromEnd, false);
    ...
    {
      return android.support.v4.view.s.j(this.mRecyclerView);
    }
    ...
    public void ignoreView(View paramView)
    {
      ...
      this.mRecyclerView.mViewInfoStore.g(localViewHolder);
    }
    ...
    {
      onInitializeAccessibilityNodeInfo(this.mRecyclerView.mRecycler, this.mRecyclerView.mState, paramb);
    }
    ...
    public void onInitializeAccessibilityNodeInfo(RecyclerView.Recycler paramRecycler, RecyclerView.State paramState, b paramb)
    {
      ...
      paramb.a(b.b.a(getRowCountForAccessibility(paramRecycler, paramState), getColumnCountForAccessibility(paramRecycler, paramState), isLayoutHierarchical(paramRecycler, paramState), getSelectionModeForAccessibility(paramRecycler, paramState)));
    }
    ...
    void onInitializeAccessibilityNodeInfoForItem(View paramView, b paramb)
    {
      ...
      if ((localViewHolder != null) && (!localViewHolder.isRemoved()) && (!this.mChildHelper.c(localViewHolder.itemView))) {
        onInitializeAccessibilityNodeInfoForItem(this.mRecyclerView.mRecycler, this.mRecyclerView.mState, paramView, paramb);
      }
    }
    ...
    {
      if (this.mRecyclerView != null) {
        android.support.v4.view.s.a(this.mRecyclerView, paramRunnable);
      }
    }
  ...
  public static class RecycledViewPool
  {
    ...
    {
      a locala = (a)this.mScrap.get(paramInt);
      if (locala == null)
      {
        locala = new a();
        this.mScrap.put(paramInt, locala);
      }
      return locala;
    }
    ...
    {
      a locala = getScrapDataForType(paramInt1);
      locala.b = paramInt2;
      ArrayList localArrayList = locala.a;
  ...
  public final class Recycler
  {
    ...
    private void attachAccessibilityDelegateOnBind(RecyclerView.ViewHolder paramViewHolder)
    {
      ...
      {
        View localView = paramViewHolder.itemView;
        if (android.support.v4.view.s.d(localView) == 0) {
          android.support.v4.view.s.a(localView, 1);
        }
        if (!android.support.v4.view.s.a(localView))
        {
          paramViewHolder.addFlags(16384);
          android.support.v4.view.s.a(localView, RecyclerView.this.mAccessibilityDelegate.getItemDelegate());
        }
      }
    }
    ...
    void addViewHolderToRecycledViewPool(RecyclerView.ViewHolder paramViewHolder, boolean paramBoolean)
    {
      ...
      if (paramViewHolder.hasAnyOfTheFlags(16384))
      {
        ...
        android.support.v4.view.s.a(paramViewHolder.itemView, null);
      }
      if (paramBoolean) {
    ...
    RecyclerView.ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int paramInt, boolean paramBoolean)
    {
      ...
      if (!paramBoolean)
      {
        View localView = RecyclerView.this.mChildHelper.c(paramInt);
        if (localView != null)
        {
          RecyclerView.ViewHolder localViewHolder2 = RecyclerView.getChildViewHolderInt(localView);
          RecyclerView.this.mChildHelper.e(localView);
          int n = RecyclerView.this.mChildHelper.b(localView);
          if (n == -1) {
          ...
          RecyclerView.this.mChildHelper.e(n);
          scrapView(localView);
    ...
    void recycleViewHolderInternal(RecyclerView.ViewHolder paramViewHolder)
    {
      ...
      if ((RecyclerView.this.mAdapter != null) && (bool2) && (RecyclerView.this.mAdapter.onFailedToRecycleView(paramViewHolder)))
      {
        ...
        if ((RecyclerView.ALLOW_THREAD_GAP_WORK) && (m > 0) && (!RecyclerView.this.mPrefetchRegistry.a(paramViewHolder.mPosition)))
        {
          n = m - 1;
          if (n >= 0)
          {
            int i1 = ((RecyclerView.ViewHolder)this.mCachedViews.get(n)).mPosition;
            if (RecyclerView.this.mPrefetchRegistry.a(i1)) {
              break label416;
            }
          }
          m = n + 1;
        ...
        for (int j = i1;; j = i)
        {
          ...
          for (;;)
          {
            ...
            for (;;)
            {
              ...
              bool2 = tryBindViewHolderByDeadline(localViewHolder2, RecyclerView.this.mAdapterHelper.b(paramInt), paramInt, paramLong);
              break;
              if (!RecyclerView.this.checkLayoutParams(localLayoutParams))
              {
                localLayoutParams1 = (RecyclerView.LayoutParams)RecyclerView.this.generateLayoutParams(localLayoutParams);
  ...
  public static abstract class ViewHolder
  {
    ...
    {
      return ((0x10 & this.mFlags) == 0) && (android.support.v4.view.s.b(this.itemView));
    }
    
    private void onEnteredHiddenState(RecyclerView paramRecyclerView)
    {
      if (this.mPendingAccessibilityState != -1) {}
      for (this.mWasImportantForAccessibilityBeforeHidden = this.mPendingAccessibilityState;; this.mWasImportantForAccessibilityBeforeHidden = android.support.v4.view.s.d(this.itemView))
      {
    ...
    implements Runnable
  {
    ...
    public void a(int paramInt1, int paramInt2, Interpolator paramInterpolator)
    {
      ...
      a(paramInt1, paramInt2, i, paramInterpolator);
    }
    ...
    public void run()
    {
      ...
      for (int i1 = i19;; i1 = k)
      {
        ...
        if (RecyclerView.this.mAdapter != null)
        {
          ...
          if (i1 != 0)
          {
            i12 = RecyclerView.this.mLayout.scrollHorizontallyBy(i1, RecyclerView.this.mRecycler, RecyclerView.this.mState);
            i4 = i1 - i12;
            if (n != 0)
            {
              i14 = RecyclerView.this.mLayout.scrollVerticallyBy(n, RecyclerView.this.mRecycler, RecyclerView.this.mState);
              i13 = n - i14;
              android.support.v4.os.c.a();
              ...
              {
                i16 = RecyclerView.this.mState.getItemCount();
                if (i16 == 0)
                {
          ...
          for (int i10 = i11;; i10 = 0)
          {
            ...
            for (;;)
            {
              ...
              for (;;)
              {
                ...
                d();
                return;
                if (localSmoothScroller.getTargetPosition() >= i16)
                {
                  localSmoothScroller.setTargetPosition(i16 - 1);
                  localSmoothScroller.onAnimation(i1 - i4, n - i13);
                  i5 = i13;
                  int i17 = i14;
                  i2 = i12;
                  i3 = i17;
