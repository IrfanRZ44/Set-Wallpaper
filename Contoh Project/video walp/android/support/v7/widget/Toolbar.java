  ...
  extends ViewGroup
{
  ...
  public Toolbar(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    TintTypedArray localTintTypedArray = TintTypedArray.obtainStyledAttributes(getContext(), paramAttributeSet, a.j.Toolbar, paramInt, 0);
    this.mTitleTextAppearance = localTintTypedArray.getResourceId(a.j.Toolbar_titleTextAppearance, 0);
    this.mSubtitleTextAppearance = localTintTypedArray.getResourceId(a.j.Toolbar_subtitleTextAppearance, 0);
    this.mGravity = localTintTypedArray.getInteger(a.j.Toolbar_android_gravity, this.mGravity);
    this.mButtonGravity = localTintTypedArray.getInteger(a.j.Toolbar_buttonGravity, 48);
    int i = localTintTypedArray.getDimensionPixelOffset(a.j.Toolbar_titleMargin, 0);
    if (localTintTypedArray.hasValue(a.j.Toolbar_titleMargins)) {
      i = localTintTypedArray.getDimensionPixelOffset(a.j.Toolbar_titleMargins, i);
    }
    this.mTitleMarginBottom = i;
    this.mTitleMarginTop = i;
    this.mTitleMarginEnd = i;
    this.mTitleMarginStart = i;
    int j = localTintTypedArray.getDimensionPixelOffset(a.j.Toolbar_titleMarginStart, -1);
    if (j >= 0) {
      this.mTitleMarginStart = j;
    }
    int k = localTintTypedArray.getDimensionPixelOffset(a.j.Toolbar_titleMarginEnd, -1);
    if (k >= 0) {
      this.mTitleMarginEnd = k;
    }
    int m = localTintTypedArray.getDimensionPixelOffset(a.j.Toolbar_titleMarginTop, -1);
    if (m >= 0) {
      this.mTitleMarginTop = m;
    }
    int n = localTintTypedArray.getDimensionPixelOffset(a.j.Toolbar_titleMarginBottom, -1);
    if (n >= 0) {
      this.mTitleMarginBottom = n;
    }
    this.mMaxButtonHeight = localTintTypedArray.getDimensionPixelSize(a.j.Toolbar_maxButtonHeight, -1);
    int i1 = localTintTypedArray.getDimensionPixelOffset(a.j.Toolbar_contentInsetStart, -2147483648);
    int i2 = localTintTypedArray.getDimensionPixelOffset(a.j.Toolbar_contentInsetEnd, -2147483648);
    int i3 = localTintTypedArray.getDimensionPixelSize(a.j.Toolbar_contentInsetLeft, 0);
    int i4 = localTintTypedArray.getDimensionPixelSize(a.j.Toolbar_contentInsetRight, 0);
    ensureContentInsets();
    this.mContentInsets.b(i3, i4);
    if ((i1 != -2147483648) || (i2 != -2147483648)) {
      this.mContentInsets.a(i1, i2);
    }
    this.mContentInsetStartWithNavigation = localTintTypedArray.getDimensionPixelOffset(a.j.Toolbar_contentInsetStartWithNavigation, -2147483648);
    this.mContentInsetEndWithActions = localTintTypedArray.getDimensionPixelOffset(a.j.Toolbar_contentInsetEndWithActions, -2147483648);
    this.mCollapseIcon = localTintTypedArray.getDrawable(a.j.Toolbar_collapseIcon);
    this.mCollapseDescription = localTintTypedArray.getText(a.j.Toolbar_collapseContentDescription);
    CharSequence localCharSequence1 = localTintTypedArray.getText(a.j.Toolbar_title);
    if (!TextUtils.isEmpty(localCharSequence1)) {
      setTitle(localCharSequence1);
    }
    CharSequence localCharSequence2 = localTintTypedArray.getText(a.j.Toolbar_subtitle);
    if (!TextUtils.isEmpty(localCharSequence2)) {
      setSubtitle(localCharSequence2);
    }
    this.mPopupContext = getContext();
    setPopupTheme(localTintTypedArray.getResourceId(a.j.Toolbar_popupTheme, 0));
    Drawable localDrawable1 = localTintTypedArray.getDrawable(a.j.Toolbar_navigationIcon);
    if (localDrawable1 != null) {
      setNavigationIcon(localDrawable1);
    }
    CharSequence localCharSequence3 = localTintTypedArray.getText(a.j.Toolbar_navigationContentDescription);
    if (!TextUtils.isEmpty(localCharSequence3)) {
      setNavigationContentDescription(localCharSequence3);
    }
    Drawable localDrawable2 = localTintTypedArray.getDrawable(a.j.Toolbar_logo);
    if (localDrawable2 != null) {
      setLogo(localDrawable2);
    }
    CharSequence localCharSequence4 = localTintTypedArray.getText(a.j.Toolbar_logoDescription);
    if (!TextUtils.isEmpty(localCharSequence4)) {
      setLogoDescription(localCharSequence4);
    }
    if (localTintTypedArray.hasValue(a.j.Toolbar_titleTextColor)) {
      setTitleTextColor(localTintTypedArray.getColor(a.j.Toolbar_titleTextColor, -1));
    }
    if (localTintTypedArray.hasValue(a.j.Toolbar_subtitleTextColor)) {
      setSubtitleTextColor(localTintTypedArray.getColor(a.j.Toolbar_subtitleTextColor, -1));
    }
  ...
  private void ensureNavButtonView()
  {
    ...
    {
      this.mNavButtonView = new AppCompatImageButton(getContext(), null, a.a.toolbarNavigationButtonStyle);
      LayoutParams localLayoutParams = generateDefaultLayoutParams();
  ...
  {
    if (this.mExpandedMenuPresenter == null) {}
    for (j localj = null;; localj = this.mExpandedMenuPresenter.b)
    {
      if (localj != null) {
  ...
  void ensureCollapseButtonView()
  {
    ...
    {
      this.mCollapseButtonView = new AppCompatImageButton(getContext(), null, a.a.toolbarNavigationButtonStyle);
