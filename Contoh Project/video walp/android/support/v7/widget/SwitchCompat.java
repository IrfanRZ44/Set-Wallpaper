  ...
  extends CompoundButton
{
  ...
  public SwitchCompat(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    TintTypedArray localTintTypedArray = TintTypedArray.obtainStyledAttributes(paramContext, paramAttributeSet, a.j.SwitchCompat, paramInt, 0);
    this.mThumbDrawable = localTintTypedArray.getDrawable(a.j.SwitchCompat_android_thumb);
    if (this.mThumbDrawable != null) {
      this.mThumbDrawable.setCallback(this);
    }
    this.mTrackDrawable = localTintTypedArray.getDrawable(a.j.SwitchCompat_track);
    if (this.mTrackDrawable != null) {
      this.mTrackDrawable.setCallback(this);
    }
    this.mTextOn = localTintTypedArray.getText(a.j.SwitchCompat_android_textOn);
    this.mTextOff = localTintTypedArray.getText(a.j.SwitchCompat_android_textOff);
    this.mShowText = localTintTypedArray.getBoolean(a.j.SwitchCompat_showText, true);
    this.mThumbTextPadding = localTintTypedArray.getDimensionPixelSize(a.j.SwitchCompat_thumbTextPadding, 0);
    this.mSwitchMinWidth = localTintTypedArray.getDimensionPixelSize(a.j.SwitchCompat_switchMinWidth, 0);
    this.mSwitchPadding = localTintTypedArray.getDimensionPixelSize(a.j.SwitchCompat_switchPadding, 0);
    this.mSplitTrack = localTintTypedArray.getBoolean(a.j.SwitchCompat_splitTrack, false);
    ColorStateList localColorStateList1 = localTintTypedArray.getColorStateList(a.j.SwitchCompat_thumbTint);
    if (localColorStateList1 != null)
    {
      this.mThumbTintList = localColorStateList1;
      this.mHasThumbTint = true;
    }
    PorterDuff.Mode localMode1 = DrawableUtils.parseTintMode(localTintTypedArray.getInt(a.j.SwitchCompat_thumbTintMode, -1), null);
    ...
    ColorStateList localColorStateList2 = localTintTypedArray.getColorStateList(a.j.SwitchCompat_trackTint);
    if (localColorStateList2 != null)
    {
      this.mTrackTintList = localColorStateList2;
      this.mHasTrackTint = true;
    }
    PorterDuff.Mode localMode2 = DrawableUtils.parseTintMode(localTintTypedArray.getInt(a.j.SwitchCompat_trackTintMode, -1), null);
    ...
    int i = localTintTypedArray.getResourceId(a.j.SwitchCompat_switchTextAppearance, 0);
    if (i != 0) {
  ...
  private void applyThumbTint()
  {
    if ((this.mThumbDrawable != null) && ((this.mHasThumbTint) || (this.mHasThumbTintMode)))
    {
      ...
      if (this.mHasThumbTint) {
        android.support.v4.a.a.a.a(this.mThumbDrawable, this.mThumbTintList);
      }
      if (this.mHasThumbTintMode) {
        android.support.v4.a.a.a.a(this.mThumbDrawable, this.mThumbTintMode);
      }
  ...
  private void applyTrackTint()
  {
    if ((this.mTrackDrawable != null) && ((this.mHasTrackTint) || (this.mHasTrackTintMode)))
    {
      ...
      if (this.mHasTrackTint) {
        android.support.v4.a.a.a.a(this.mTrackDrawable, this.mTrackTintList);
      }
      if (this.mHasTrackTintMode) {
        android.support.v4.a.a.a.a(this.mTrackDrawable, this.mTrackTintMode);
      }
    ...
    for (int i1 = i4;; i1 = n)
    {
      if (this.mThumbDrawable != null)
      {
        ...
        if (localDrawable != null) {
          android.support.v4.a.a.a.a(localDrawable, i2, j, i3, m);
        }
      }
  ...
  public void drawableHotspotChanged(float paramFloat1, float paramFloat2)
  {
    ...
    if (this.mThumbDrawable != null) {
      android.support.v4.a.a.a.a(this.mThumbDrawable, paramFloat1, paramFloat2);
    }
    if (this.mTrackDrawable != null) {
      android.support.v4.a.a.a.a(this.mTrackDrawable, paramFloat1, paramFloat2);
    }
  }
  ...
  public void setSwitchTextAppearance(Context paramContext, int paramInt)
  {
    ...
    if (localColorStateList != null)
    {
      ...
      int i = localTintTypedArray.getDimensionPixelSize(a.j.TextAppearance_android_textSize, 0);
      if ((i != 0) && (i != this.mTextPaint.getTextSize()))
      {
        this.mTextPaint.setTextSize(i);
        requestLayout();
      }
      setSwitchTypefaceByIndex(localTintTypedArray.getInt(a.j.TextAppearance_android_typeface, -1), localTintTypedArray.getInt(a.j.TextAppearance_android_textStyle, -1));
      if (!localTintTypedArray.getBoolean(a.j.TextAppearance_textAllCaps, false)) {
        break label134;
      }
    }
    label134:
    for (this.mSwitchTransformationMethod = new android.support.v7.f.a(getContext());; this.mSwitchTransformationMethod = null)
    {
      localTintTypedArray.recycle();
      return;
