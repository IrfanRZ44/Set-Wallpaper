  ...
  extends LinearLayoutManager
{
  ...
  private void ensureAnchorIsInCorrectSpan(RecyclerView.Recycler paramRecycler, RecyclerView.State paramState, LinearLayoutManager.a parama, int paramInt)
  {
    ...
    for (;;)
    {
      j = getSpanIndex(paramRecycler, paramState, parama.b);
      if (i == 0) {
        break;
      }
      while ((j > 0) && (parama.b > 0))
      {
        parama.b = (-1 + parama.b);
        j = getSpanIndex(paramRecycler, paramState, parama.b);
      }
  ...
  void layoutChunk(RecyclerView.Recycler paramRecycler, RecyclerView.State paramState, LinearLayoutManager.b paramb, LinearLayoutManager.LayoutChunkResult paramLayoutChunkResult)
  {
    ...
    {
      int i26;
      if ((n < this.mSpanCount) && (paramb.a(paramState)) && (m > 0))
      {
        int i25 = paramb.d;
      ...
      do
      {
        ...
        return;
        localView5 = paramb.a(paramRecycler);
      ...
      for (;;)
      {
        ...
        if (i4 < n)
        {
          ...
          for (int i21 = View.MeasureSpec.makeMeasureSpec(i3 - i17, 1073741824);; i21 = getChildMeasureSpec(i19, 1073741824, i17, localLayoutParams2.height, false))
          {
            ...
            break;
            label704:
            i20 = View.MeasureSpec.makeMeasureSpec(i3 - i18, 1073741824);
          }
        }
        ...
        for (;;)
        {
          ...
          break;
          label1020:
          i12 = getPaddingLeft() + this.mCachedBorders[localLayoutParams1.mSpanIndex];
          i11 = i12 + this.mOrientationHelper.getDecoratedMeasurementInOther(localView1);
          continue;
          label1054:
          i10 = getPaddingTop() + this.mCachedBorders[localLayoutParams1.mSpanIndex];
  ...
  public View onFocusSearchFailed(View paramView, int paramInt, RecyclerView.Recycler paramRecycler, RecyclerView.State paramState)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        label634:
        i19 = localLayoutParams2.mSpanIndex;
  ...
  public void onInitializeAccessibilityNodeInfoForItem(RecyclerView.Recycler paramRecycler, RecyclerView.State paramState, View paramView, b paramb)
  {
    ...
    if (this.mOrientation == 0)
    {
      ...
      {
        paramb.b(b.c.a(m, n, i, 1, bool2, false));
        return;
      }
    }
    ...
    {
      paramb.b(b.c.a(i, 1, j, k, bool1, false));
      return;
    }
  }
