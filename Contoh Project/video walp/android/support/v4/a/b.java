  ...
  private static float[] c(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          float[] arrayOfFloat2 = a(arrayOfFloat1, 0, i);
  ...
  public static class b
  {
    ...
    private static void a(Path paramPath, float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, float paramFloat5, float paramFloat6, float paramFloat7, boolean paramBoolean1, boolean paramBoolean2)
    {
      ...
      for (d20 -= 6.283185307179586D;; d20 += 6.283185307179586D)
      {
        ...
        a(paramPath, d21 * d2 - d22 * d3, d21 * d3 + d22 * d2, paramFloat5, paramFloat6, paramFloat1, paramFloat2, d1, d19, d20);
        return;
        d17 = d16 + d10;
        d18 = d11 - d15;
        break;
      ...
      for (float f56 = f9 - f4;; f56 = 0.0F)
      {
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            ...
            {
              a(paramPath, f10, f9, f24, f25, f26, f27, f28, bool3, bool4);
            ...
            {
              a(paramPath, f10, f9, f11, f12, f13, f14, f15, bool1, bool2);
