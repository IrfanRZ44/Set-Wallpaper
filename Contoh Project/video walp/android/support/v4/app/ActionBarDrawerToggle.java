  ...
  implements DrawerLayout.c
{
  ...
  public ActionBarDrawerToggle(Activity paramActivity, DrawerLayout paramDrawerLayout, boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if ((paramActivity instanceof DelegateProvider))
    {
      ...
      this.mDrawerImage = a.getDrawable(paramActivity, paramInt1);
  ...
  public void setHomeAsUpIndicator(int paramInt)
  {
    ...
    if (paramInt != 0) {
      localDrawable = a.getDrawable(this.mActivity, paramInt);
    }
    ...
    implements Drawable.Callback
  {
    ...
    public void draw(Canvas paramCanvas)
    {
      ...
      paramCanvas.save();
      if (s.e(ActionBarDrawerToggle.this.mActivity.getWindow().getDecorView()) == i) {}
      for (int j = i;; j = 0)
      {
        if (j != 0) {
          i = -1;
