  ...
  implements Parcelable
{
  ...
  public Fragment instantiate(FragmentHostCallback paramFragmentHostCallback, FragmentContainer paramFragmentContainer, Fragment paramFragment, FragmentManagerNonConfig paramFragmentManagerNonConfig, v paramv)
  {
    ...
    for (this.mInstance = paramFragmentContainer.instantiate(localContext, this.mClassName, this.mArguments);; this.mInstance = Fragment.instantiate(localContext, this.mClassName, this.mArguments))
    {
      ...
      this.mInstance.mViewModelStore = paramv;
