...
public class Fragment
  implements h, w, ComponentCallbacks, View.OnCreateContextMenuListener
{
  ...
  public LayoutInflater getLayoutInflater(Bundle paramBundle)
  {
    ...
    android.support.v4.view.e.b(localLayoutInflater, this.mChildFragmentManager.getLayoutInflaterFactory());
